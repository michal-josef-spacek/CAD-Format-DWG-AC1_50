...
sub _read {
    ...
    $self->{entities_block} = CAD::Format::DWG::AC1_50::RealEntities->new($io__raw_entities_block, $self, $self->{_root});
    if ($self->header()->extra_entities_start() > 0) {
        ...
        $self->{entities_extra} = CAD::Format::DWG::AC1_50::RealEntities->new($io__raw_entities_extra, $self, $self->{_root});
    }
    if (!($self->_io()->is_eof())) {
        $self->{todo} = ();
...
########################################################################
package CAD::Format::DWG::AC1_50::EntityJump;
...
sub _read {
    ...
    elsif ($_on == $CAD::Format::DWG::AC1_50::ENTITIES_JUMP) {
        $self->{data} = CAD::Format::DWG::AC1_50::EntityJump->new($self->{_io}, $self, $self->{_root});
    }
...
sub _read {
    ...
    $self->{table_block} = CAD::Format::DWG::AC1_50::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{table_layer} = CAD::Format::DWG::AC1_50::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{table_style} = CAD::Format::DWG::AC1_50::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{table_linetype} = CAD::Format::DWG::AC1_50::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{table_view} = CAD::Format::DWG::AC1_50::HeaderTable->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package CAD::Format::DWG::AC1_50::HeaderTable;
